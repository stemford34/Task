...
TEMPLATE_PATH = os.path.join(BASE_DIR, "TaskManager/templates")
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'xw7tx_s9xug5o_t(u&#$ne#51665icj!ei3jihifl%(mo^&pa-'
...
INSTALLED_APPS = [
    ...
    'TaskManager.index',
    'TaskManager.authorization',
    'TaskManager.table_editor',
]
...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, "base/base/static"),
#     '/base/static/',
# ]
